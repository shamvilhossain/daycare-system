...
<head>
    ...
    <title>Add New Activity | KinderCare</title>
    <!-- Google Fonts -->
                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-8">
                            <div class="d-flex justify-content-between align-items-center mb-3">
                                <div>
                                    <h3 class="mb-0 fw-bold">Add New Activity</h3>
                                    <p class="text-muted small">Register a new activity template to the daycare curriculum</p>
                                </div>
                                    ...
                                    <form action="{{ route('admin.activities.store') }}" method="POST">
                                        ...
                                        <div class="row g-3">
                                            <div class="col-md-8">
                                                ...
                                                <input type="text" class="form-control @error('name') is-invalid @enderror" id="name" name="name" value="{{ old('name') }}" placeholder="e.g., Finger Painting, Sing-Along Time" required>
                                                @error('name')
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="input-group">
                                                    <input type="number" class="form-control @error('duration_minutes') is-invalid @enderror" id="duration_minutes" name="duration_minutes" value="{{ old('duration_minutes', 30) }}" min="5" max="480">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <input type="text" class="form-control @error('materials_needed') is-invalid @enderror" id="materials_needed" name="materials_needed" value="{{ old('materials_needed') }}" placeholder="e.g., Paper sheets, water paints, aprons">
                                            ...
                                            <div class="col-12">
                                                ...
                                                <textarea class="form-control @error('description') is-invalid @enderror" id="description" name="description" rows="4" placeholder="Describe the learning objectives, steps, and target age benefits...">{{ old('description') }}</textarea>
                                                @error('description')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            </div>
                                            ...
                                            <div class="col-12">
                                                <div class="form-check form-switch mt-2">
                                                    ...
                                                    <div class="form-text">Inactive activities cannot be scheduled for upcoming sessions.</div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-12 pt-3 border-top d-flex justify-content-end gap-2">
                                                ...
                                                <button type="submit" class="btn btn-primary px-4"><i class="bi bi-check-lg me-1"></i> Save Activity</button>
                                            </div>
                                        </div>
                                    </form>
                                </div>
