...
<head>
    ...
    <meta name="description" content="Edit user account, assign Spatie role, and build profile.">
    <title>Edit User | Daycare System</title>
        ...
        <main class="app-main">
            <div class="app-content-header">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-sm-6">
                            <h3 class="mb-0 fw-bold" style="color: #1e1b4b;">Edit User: {{ $user->name }}</h3>
                        </div>
                        <div class="col-sm-6">
            ...
            <div class="app-content">
                <div class="container-fluid">
                    ...
                    {{-- Form Card --}}
                    <form action="{{ route('admin.users.update', $user) }}" method="POST" id="editUserForm" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                                ...
                                <div class="card-form h-100">
                                    ...
                                    <div class="card-body p-4">
                                            ...
                                            <div class="row g-2">
                                                <div class="col-12">
                                                    <label class="role-option-card" id="cardRoleParent" for="roleParent">
                                                        <input class="form-check-input visually-hidden" type="radio" name="role" id="roleParent" value="parent" {{ old('role', $user->role) === 'parent' ? 'checked' : '' }} onchange="onRoleChanged(this.value)">
                                                ...
                                                <div class="col-12">
                                                    <label class="role-option-card" id="cardRoleStaff" for="roleStaff">
                                                        <input class="form-check-input visually-hidden" type="radio" name="role" id="roleStaff" value="staff" {{ old('role', $user->role) === 'staff' ? 'checked' : '' }} onchange="onRoleChanged(this.value)">
                                                ...
                                                <div class="col-12">
                                                    <label class="role-option-card" id="cardRoleAdmin" for="roleAdmin">
                                                        <input class="form-check-input visually-hidden" type="radio" name="role" id="roleAdmin" value="admin" {{ old('role', $user->role) === 'admin' ? 'checked' : '' }} onchange="onRoleChanged(this.value)">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="email" class="form-control @error('email') is-invalid @enderror" id="email" name="email" value="{{ old('email', $user->email) }}" placeholder="e.g. user@daycare.com" required>
                                            @error('email')
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="password" class="form-control" id="password_confirmation" name="password_confirmation" placeholder="Re-type password if changing">
                                        </div>
                                    ...
                                    <div class="card-body p-4">
                                        ...
                                        <div class="row g-3 mb-4">
                                            <div class="col-12 col-sm-6">
                                                ...
                                                <input type="text" class="form-control @error('first_name') is-invalid @enderror" id="first_name" name="first_name" value="{{ old('first_name', $user->profile?->first_name) }}" placeholder="First name" required>
                                                @error('first_name')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            </div>
                                            <div class="col-12 col-sm-6">
                                                ...
                                                <input type="text" class="form-control @error('last_name') is-invalid @enderror" id="last_name" name="last_name" value="{{ old('last_name', $user->profile?->last_name) }}" placeholder="Last name" required>
                                                @error('last_name')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            </div>
                                            <div class="col-12">
                                                ...
                                                @if($user->profile?->image)
                                                    <div class="mb-2">
                                                        <img src="{{ Storage::url($user->profile->image) }}" alt="Profile" class="rounded-circle border" width="64" height="64" style="object-fit: cover;">
                                                    </div>
                                                @endif
                                                ...
                                                @error('image')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                                <div class="form-text text-muted small">Allowed: jpg, png, gif, svg. Max size: 2MB. Leave blank to keep current image.</div>
                                            </div>
                                        </div>
                                        ...
                                        <div id="parentFieldsSection" class="role-fields-container">
                                            ...
                                            <div class="row g-3">
                                                ...
                                                <div class="col-12 col-sm-6">
                                                    ...
                                                    <input type="text" class="form-control" id="occupation" name="occupation" value="{{ old('occupation', $user->parentProfile?->occupation) }}" placeholder="e.g. Engineer, Teacher, Doctor">
                                                </div>
                                                <div class="col-12 col-sm-6">
                                                    <label for="city" class="form-label">City</label>
                                                    <input type="text" class="form-control" id="city" name="city" value="{{ old('city', $user->parentProfile?->city) }}" placeholder="e.g. Dhaka">
                                                </div>
                                                <div class="col-12">
                                                    <label for="address" class="form-label">Residential Address</label>
                                                    <textarea class="form-control" id="address" name="address" rows="3" placeholder="Full residential street address">{{ old('address', $user->parentProfile?->address) }}</textarea>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div id="staffFieldsSection" class="role-fields-container" style="display: none;">
                                            ...
                                            <div class="row g-3">
                                                ...
                                                <div class="col-12 col-sm-6">
                                                    ...
                                                    <input type="text" class="form-control" id="staff_nid" name="nid" value="{{ old('nid', $user->staffProfile?->nid) }}" placeholder="e.g. 9876543210">
                                                </div>
                                                <div class="col-12 col-sm-6">
                                                    <label for="date_of_birth" class="form-label">Date of Birth</label>
                                                    <input type="date" class="form-control" id="date_of_birth" name="date_of_birth" value="{{ old('date_of_birth', $user->staffProfile?->date_of_birth) }}">
                                                </div>
                                                <div class="col-12 col-sm-6">
                                                    <label for="hire_date" class="form-label">Hire Date</label>
                                                    <input type="date" class="form-control" id="hire_date" name="hire_date" value="{{ old('hire_date', $user->staffProfile?->hire_date ?? date('Y-m-d')) }}">
                                                </div>
                                                <div class="col-12">
                                                    <label for="note" class="form-label">Staff Notes / Bio</label>
                                                    <textarea class="form-control" id="note" name="note" rows="3" placeholder="Additional notes about this staff member">{{ old('note', $user->staffProfile?->note) }}</textarea>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div id="adminFieldsSection" class="role-fields-container" style="display: none;">
                                            ...
                                            <div class="row g-3">
                                                <div class="col-12 col-sm-6">
                                                    ...
                                                    <input type="text" class="form-control" id="admin_nid" name="nid" value="{{ old('nid', $user->staffProfile?->nid) }}" placeholder="e.g. 9876543210">
                                                </div>
                                                <div class="col-12 col-sm-6">
                                                    <label for="admin_hire_date" class="form-label">Appointment / Hire Date</label>
                                                    <input type="date" class="form-control" id="admin_hire_date" name="hire_date" value="{{ old('hire_date', $user->staffProfile?->hire_date ?? date('Y-m-d')) }}">
                                                </div>
                                                <div class="col-12">
                                                    <label for="admin_note" class="form-label">Administrative Notes</label>
                                                    <textarea class="form-control" id="admin_note" name="note" rows="3" placeholder="Administrative duties or notes">{{ old('note', $user->staffProfile?->note ?? 'System Administrator') }}</textarea>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="d-flex align-items-center justify-content-end gap-3 mt-5 pt-3 border-top">
                                            ...
                                            <button type="submit" class="btn btn-submit d-inline-flex align-items-center gap-2">
                                                <i class="bi bi-person-check-fill"></i> Update User & Profile
                                            </button>
                                        </div>
