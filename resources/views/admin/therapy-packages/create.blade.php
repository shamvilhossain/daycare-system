...
<head>
    ...
    <title>New Therapy Package | KinderCare</title>
        ...
        <main class="app-main">
            <div class="app-content-header">
                <div class="container-fluid">
                    <div class="row align-items-center">
                        <div class="col-sm-6"><h3 class="mb-0"><i class="bi bi-gift me-2"></i>New Therapy Package</h3></div>
            ...
            <div class="app-content">
                <div class="container-fluid">
                    ...
                    <form action="{{ route('admin.therapy-packages.store') }}" method="POST" id="packageForm">
                        @csrf
                        <div class="row g-3">
                            <div class="col-lg-8">
                                {{-- Package Info --}}
                                    ...
                                    <div class="card-body">
                                        <div class="row g-3">
                                            <div class="col-md-8">
                                                ...
                                                <input type="text" name="name" class="form-control @error('name') is-invalid @enderror" value="{{ old('name') }}" placeholder="e.g. Basic SLT Bundle, Premium Combo Pack" required>
                                                @error('name')<div class="invalid-feedback">{{ $message }}</div>@enderror
                                            </div>
                                            <div class="col-md-4">
                                                <label class="form-label fw-semibold">Package Price (৳) <span class="text-danger">*</span></label>
                                                <input type="number" name="price" step="0.01" class="form-control @error('price') is-invalid @enderror" value="{{ old('price') }}" min="0" placeholder="0.00" required>
                                ...
                                <div class="text-end mb-4">
                                    <button type="submit" class="btn btn-primary px-4"><i class="bi bi-check-circle-fill me-1"></i> Create Package</button>
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <div class="card shadow-sm border-0">
                                    ...
                                    <div class="card-body small text-muted">
                                        <ul class="ps-3 mb-0">
                                            <li class="mb-2"><strong>Price</strong> is admin-set and not auto-calculated from individual session rates.</li>
                                            <li class="mb-2"><strong>Session Count</strong> per service determines how many sessions of that type the child gets when purchasing.</li>
                                            <li><strong>Inactive</strong> packages won't appear for purchase but existing purchased instances remain valid.</li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
